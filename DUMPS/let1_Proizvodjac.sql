...
INSERT INTO `Proizvodjac` VALUES (1,'Boeing (Cikago, SAD)','Cikago','SAD'),(2,'Airbus SAS (Tuluz, Francuska)','Tuluz','Francuska'),(3,'Embraer (Sao Paolo, Brazil)','Sao Paolo','Brazil'),(4,'Tupolev (Moskva, Rusija)','Moskva','Rusija');
